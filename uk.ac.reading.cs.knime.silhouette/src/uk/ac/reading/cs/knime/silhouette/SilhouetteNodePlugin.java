 ...
 */
public class SilhouetteNodePlugin extends Plugin {
    // The shared instance.
    private static SilhouetteNodePlugin plugin;

    /**
     * The constructor.
     */
    public SilhouetteNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static SilhouetteNodePlugin getDefault() {
        return plugin;
    }
